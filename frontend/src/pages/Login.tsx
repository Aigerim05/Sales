    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-purple-50 to-indigo-200 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <Card className="w-full max-w-xl bg-white/90 backdrop-blur-sm border-white/20 shadow-2xl">
        <CardHeader className="space-y-4 text-center pb-10">
          <CardTitle className="text-4xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Welcome Back</CardTitle>
          <CardDescription className="text-gray-600 text-xl">
            Sign in to your Sales Coach AI account
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-8 px-10 pb-10">
          <form className="space-y-8" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between pt-4">
              <Link to="/forgot-password" className="text-lg text-blue-600 hover:text-blue-700 font-medium transition-colors">
                Forgot password?
              </Link>
            </div>
            {error && <div className="text-red-600 text-center text-lg">{error}</div>}
            <Button type="submit" className="w-full bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 hover:from-blue-700 hover:via-purple-700 hover:to-indigo-700 text-white h-14 text-lg font-semibold shadow-lg" disabled={loading}>
          ...
          <div className="text-center text-lg text-gray-600 pt-6">
